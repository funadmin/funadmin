...
final class ManagedGenerationService
{
    ...
    private function buildBundle(int $moduleId, string $nonce): array
    {
        ...
        $baselineInputs = $this->baselineInputs($moduleId);
        $plan = $generator->planManaged($definition, $baselineInputs);
        $merged = [];
