...
namespace app\console\authorization\service;

use app\console\authorization\model\AuthGroup;
use app\console\authorization\model\AuthGroupDepartment;
use app\console\authorization\model\AuthGroupFieldPermission;
use app\console\authorization\model\AuthGroupInherit;
use app\console\authorization\model\Permission;
use app\console\authorization\model\PermissionField;
