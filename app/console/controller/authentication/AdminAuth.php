...
namespace app\console\controller\authentication;
...
class AdminAuth extends BaseController
{
    ...
    {
        $mapping = [
            'console/development.business:modules' => 'development:business:view',
            'console/development.business:module' => 'development:business:view',
            'console/development.business:createvisual' => 'development:business:save',
            'console/development.business:inspectdatabase' => 'development:business:inspect',
            'console/development.business:createfromdatabase' => 'development:business:save',
            'console/development.business:validateschema' => 'development:business:save',
            'console/development.business:saveschema' => 'development:business:save',
            'console/development.business:compileschema' => 'development:business:save',
            'console/development.business:exportschema' => 'development:business:view',
            'console/development.business:schemaversions' => 'development:business:view',
            'console/development.business:schemaversion' => 'development:business:view',
            'console/development.business:schemadiff' => 'development:business:view',
            'console/development.business:rollbackschema' => 'development:business:save',
            'console/development.business:databasetables' => 'development:business:inspect',
            'console/development.business:databasetableschema' => 'development:business:inspect',
            'console/development.business:previewpublish' => 'development:business:publish',
            'console/development.business:publish' => 'development:business:publish',
            'console/development.business:runtimemeta' => 'development:business:view',
            'console/development.business:previewformalgeneration' => 'development:business:generate',
            ...
            'console/systemrole:authorization' => 'system:role:perm',
            'console/systemrole:saveauthorization' => 'system:role:perm',
            'console/systemrole:copyauthorization' => 'system:role:perm-copy',
