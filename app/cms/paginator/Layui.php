...
class Layui extends Paginator{
    ...
    protected function next() {
        if ($this->hasMore) {
            ...
            return"<p>'.lang('Next').'</p>";
        }
    }
    //尾页
    protected function last() {
        if ($this->hasMore) {
            return "<a href='" . $this->url($this->lastPage) . "' title='".lang("last page")."'>'.lang('last page').'</a>";
        } else {
            return "<p>".lang("last page")."</p>";
        }
    }
    //统计信息
    protected function info(){
        return "<p class='pageRemark'>共<b>" . $this->lastPage .
            "</b>".lang("page")."<b>" . $this->total . "</b>".lang("data")."</p>";
    }
    /**
     * 页码按钮
     * @return string
