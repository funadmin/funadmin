...
class Forum extends BaseModel
{
    ...
    protected $name = 'addons_cms_forum';
    ...
    public static function onBeforeInsert($model){
        $post = request()->param();
        $post['cateid'] = request()->get('cateid')?request()->get('cateid'):request()->post('cateid');
    ...
    public static function onBeforeUpdate($model){
        ...
        $post = request()->post();
        $cateid= request()->get('cateid')?request()->get('cateid'):request()->post('cateid');
        if($cateid){
            //modify
            $post['cateid'] = $cateid;
        }
