...
trait AdminJsonResponse
{
    ...
    {
        return \app\admin\http\AdminResponse::httpStatus($code);
    }

    protected function jsonResponse(string $msg, mixed $data, int $code): \think\Response
    {
        return \app\admin\http\AdminResponse::create($msg, $data, $code, $this->responseHttpStatus($code), $this->responseHeaders());
    }
