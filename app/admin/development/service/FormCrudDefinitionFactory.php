...
final class FormCrudDefinitionFactory
{
    ...
    public function forBusinessTarget(CrudDefinition $definition, array $target): CrudDefinition
    {
        ...
        $data['target'] = ['type' => 'plugin', 'plugin' => $plugin, 'scope' => 'admin'];
        $data['module'] = $plugin;
    ...
    private function field(array $field, string $type, array &$relations, array &$optionSources, string $prefix): array
    {
        ...
        $hidden = (int) ($field['form_show'] ?? 1) !== 1 || $type === 'hidden';
        $row = [
    ...
    private function targets(string $entity, string $class, bool $memberApi = false): array
    {
        return ($memberApi ? ['memberApiController' => "app/api/controller/generated/{$class}Controller.php"] : []) + [
            ...
            'service' => "app/admin/service/generated/{$class}Service.php",
            'controller' => "app/admin/controller/generated/{$class}Controller.php",
