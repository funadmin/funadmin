...
final class FieldBuilder
{
    ...
    public function prop(string $name, mixed $value): self { $this->node['props'][$name] = $value; return $this; }
    ...
    public function options(array $options): self { return $this->dataSource(['kind' => 'static', 'options' => array_values($options)]); }
    ...
    public function condition(array $when, array $then): self { $this->node['conditions'][] = compact('when', 'then'); return $this; }
    ...
    public function access(array $read = [], array $write = []): self { $this->node['access'] = compact('read', 'write'); return $this; }
    public function list(bool $show = true, bool $sort = false, string $filter = '', string $formatter = '', int $width = 0): self { $this->node['list'] = compact('show', 'sort', 'filter', 'formatter', 'width'); return $this; }
