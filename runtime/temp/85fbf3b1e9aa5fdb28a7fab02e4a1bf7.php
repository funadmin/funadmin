<?php /*a:1:{s:63:"D:\wwwroot\my-space\funadmin\app\frontend\view\index\index.html";i:1650024132;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="site-banner">
        ...
        <div class="site-banner-main">
            ...
            <div class="layui-anim site-desc site-desc-anim">
                ...
                <p class="web-font-desc layui-hide-xs" style="font-size: 16px;">框架主要使用ThinkPHP6.X + layui + requirejs拥有完善的权限的管理模块以及插件的开发方式，让你开发起来更加简单。</p>
                <!--                <cite></cite>-->
            </div>
            ...
            <div class="site-version">
                <span>当前版本：<cite class="site-showv"><?php echo config('app.version'); ?></cite></span>
