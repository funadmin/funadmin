<?php /*a:1:{s:62:"D:\wwwroot\my-space\funadmin\app\backend\view\login\index.html";i:1650024132;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form layui-form-pane" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img  id="captchaPic" src="<?php echo __u('verify'); ?>?<?php echo time(); ?>" alt="captcha" onclick="this.src='<?php echo __u("verify"); ?>?'+'id='+Math.random()"/>
                    </div>
                </div>
                <?php endif; ?>
                <div class="layui-form-item">
