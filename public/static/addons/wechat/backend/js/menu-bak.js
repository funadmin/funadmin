    ...
    let Controller = {
        index: function () {
            let api_url = {
                ...
                getAccount:'addons/wechat/backend/menu/getAccount',
                getMenu:'addons/wechat/backend/menu/getMenu',
                getMaterialByType:'addons/wechat/backend/menu/getMaterialByType',
            }
            let obj;
            let mId;
            let tempObj;
            ...
            let objs;
            let ix;
            let menu = '<div className="custom-menu-view__menu"><div className="text-ellipsis"></div></div>';
            ...
            let delClick;
            //添加菜单按钮
            let customEl = '<div className="custom-menu-view__menu"> <div className="text-ellipsis">新建菜单</div></div>';
            let customUl = ' <ul className="custom-menu-view__menu__sub"> <li className="custom-menu-view__menu__sub__add"><div className="text-ellipsis"><i className="glyphicon glyphicon-plus text-info"></i></div></li> </ul>';
            let customLi = ' <li className="custom-menu-view__menu__sub__add"> <div className="text-ellipsis">新建子菜单</div> </li>';
            ...
            //删除菜单
            function deleteMenu() {
                Fun.toastr.confirm(__('Are you sure you want to delete it'), function () {
                    Fun.ajax({
                        url: api_url.delete,
            ...
            function appIdChange() {
                ...
                $.ajax({
                    url: ApiUrl + '/admin/wechat.wechat/changeApp',
                    type: "POST",
