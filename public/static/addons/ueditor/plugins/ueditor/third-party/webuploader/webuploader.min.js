...
!function (a, b) {
    ...
    return b("dollar-third", [], function () {
        ...
        return {
            version: "0.1.2", $: b, Deferred: c.Deferred, isPromise: c.isPromise, when: c.when, browser: function (a) {
        ...
        return d.extend(b.options, {pick: null, accept: null}), b.register({
            ...
            init: function (a) {
                ...
                if (b) return g = a.Deferred(), d.isPlainObject(b) || (b = {id: b}), e = d.extend({}, b, {
