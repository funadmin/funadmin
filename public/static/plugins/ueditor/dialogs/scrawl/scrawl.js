    ...
    ScaleBoy.prototype = {
        init:function () {
            ...
            domUtils.on(scale, 'mousedown', function (e) {
                ...
                domUtils.on(document.body, 'mousemove', me.scaspeedusemove);
                e.stopPropagation ? e.stopPropagation() : e.cancelBubble = true;
            });
            domUtils.on(document.body, 'mouseup', function (e) {
                if (me.start) {
                    domUtils.un(document.body, 'mousemove', me.scaspeedusemove);
                    if (me.moved) {
