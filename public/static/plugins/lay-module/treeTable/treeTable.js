layui.define(["jquery"], function (exports) {
    var MOD_NAME = "treeTable", o = layui.jquery, tree = function () {
    };
    tree.prototype.config = function () {
        return {
            ...
            icon: {open: "layui-icon layui-icon-triangle-d", close: "layui-icon layui-icon-triangle-r", left: 16},
            cols: [],
            checked: {},
            is_click_icon: false,
            is_checkbox: false,
    ...
    tree.prototype.template = function (e) {
        var t = this, level = [], tbody = "", is_table = o("table" + e.elem).length || !(e.is_click_icon = true),
        ...
        o(e.elem).html(table).off("click", click_btn).on("click", click_btn, function () {
            var tr = o(this).parents("[data-id]"), td = tr.find("[data-down]"), id = tr.data("id"),
                pid = tr.data("pid"), is_open = td.find("i:not(.layui-icon-ok)").attr("class") == e.icon.close;
            if (is_open) {
            ...
            var is_checked = o(this).toggleClass("layui-form-checked").hasClass("layui-form-checked"),
                tr = o(this).parents("[data-id]"), id = tr.data("id"), pid = tr.data("pid");
            ...
            var tr = o(this).parents("[data-id]"), id = tr.data("id"), pid = tr.data("pid"),
                filter = o(this).attr("lay-filter");
            return layui.event.call(this, MOD_NAME, "tree(" + filter + ")", {elem: this, item: e.childs[pid][id]})
        });
        e.end && e.end(e)
    };
    tree.prototype.parents_checkbox = function (e, pid) {
        var po = o(e.elem).find("[data-pid=" + pid + "]"), co = o(e.elem).find("[data-id=" + pid + "]"),
    ...
    tree.prototype.childs_hide = function (e, id) {
        ...
        o(e.elem).find("[data-pid=" + id + "]:not(." + e.hide_class + ")").each(function () {
            var td = o(this).find("[data-down]"), i = td.find("i:not(.layui-icon-ok)");
    ...
    tree.prototype.cache = function (e, val, option) {
        ...
        var t = this, name = e.elem.substr(1), val = val.toString(),
