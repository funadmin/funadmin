        ...
        index: function () {
            ...
            Table.render({
                ...
                cols: [[
                    ...
                    {field: 'mime', title: __('FileTye'), width: 80,sort: true ,templet:function (d) {
                            html = '';
                            if (d.mime == 'image/jpeg' || d.mime == 'image/gif' || d.mime == 'image/png' || d.mime == 'image/webp' || d.mime == 'image/bmp') {
                                html += '<img src="'+STATIC+'/backend/images/filetype/image.jpg" alt="图片" width="50">'
                            } else if (d.mime == 'application/pdf') {
                                html += '<img src="'+STATIC+'/backend/images/filetype/pdf.jpg" alt="pdf" width="50">'
                            } else if (d.mime == 'application/zip') {
                                html += '<img src="'+STATIC+'/backend/images/filetype/zip.jpg" alt="zip" width="50">'
                            } else if (d.mime == 'application/msexcel' || d.mime == 'application/mspowerpoint' || d.mime == 'application/msword') {
                                html += '<img src="'+STATIC+'/backend/images/filetype/office.jpg" alt="文档" width="50">'
                            } else {
                                html += '<img src="'+STATIC+'/backend/images/filetype/file.jpg" alt="文件" width="50">'
                            }
                            return html;

                        }
                    },
                    {field: 'path', title: __('Path'), minWidth: 120, sort: true, templet:Table.templet.image},
                    {field: 'ext', title: __('Ext'), width: 120,sort: true},
                    {field: 'size', title: __('Size'), width: 80, sort: true},
