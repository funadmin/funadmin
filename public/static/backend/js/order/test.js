    ...
    let Controller = {
        index: function () {
            Table.init = {
                ...
                tableId: 'list',
                requests:{
index_url:'order.test/index',
add_url:'order.test/add',
edit_url:'order.test/edit',
delete_url:'order.test/delete',
deleteAll_url:'order.test/deleteAll',
import_url:'order.test/import',
export_url:'order.test/export',
modify_url:'order.test/modify',
            ...
            Table.render({
                ...
                cols: [[
                  ...
                  {field: 'week',search: 'select',selectList:{'monday':'星期一','tuesday':'星期二','wednesday':'星期三',},title: __('星期'),sort:true,templet: Table.templet.select},
                  {field: 'sexdata',search: 'select',selectList:{'male':'男','female':'女','secret':'保密',},title: __('性别'),sort:true,templet: Table.templet.select},
                  ...
                  {field: 'teststate',search: 'select',selectList:{'1':'选项1','2':'选项2','3':'选项3',},title: __('复选'),sort:true,templet: Table.templet.select},
                  {field: 'test2state',search: 'select',selectList:{'0':'唱歌','1':'跳舞','2':'游泳',},title: __('爱好'),sort:true,templet: Table.templet.select},
                  ...
                  {field: 'status',search: 'select',selectList:{0:"enabled",1:"disabled"},title: __('状态'),sort:true,templet: Table.templet.select},
                  {
                        minwidth: 250,
                        align: "center",
                        title: __("Operat"),
