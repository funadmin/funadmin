/*** 后台总控制API*/
define(["jquery", 'layui', "lang", 'toastr', 'moment'], function ($, undefined, Lang, Toastr, Moment) {
    var layer, table;
        ...
        toastr: {
            ...
            loading: function (msg, callback) {
                layui.use('layer', function () {
                    ...
                    }) : layui.layer.load(0, {time: 0, scrollbar: false, shade: this.shade, end: callback});
                ...
                layui.use('layer', function () {
                    ...
                    options = {
                        ...
                        btn2: btn2 === undefined ? function (index) {
                            parent.layui.layer.closeAll(index);
                        } : btn2,
                    }
                    var index = layui.layer.open(options);
