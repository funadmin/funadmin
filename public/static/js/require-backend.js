...
require.config({
    ...
    baseUrl: BASE_URL,
    include: [
        'css','layCascader','treeGrid','tableSelect','treeTable','tableEdit','tableFilter','tableTree','iconPicker','iconFonts', 'toastr','step-lay','inputTags', 'timeago','multiSelect','cityPicker', 'selectPlus','selectN','selectPage','xmSelect', 'regionCheckBox','timePicker','croppers', 'backend','md5','fun','form','table','upload','addons'],
    paths: {
        'lang'          : 'empty:',
