...
require.config({
    ...
    baseUrl: BASE_URL,
    include: ['jquery','css','layCascader','tableSelect','iconPicker','iconFonts','tableFilter', 'toastr','step-lay','inputTags' ,'xmSelect', 'timeago','multiSelect','selectPlus','selectN','selectPage','cityPicker', 'regionCheckBox','timePicker','autoComplete','Sortable','croppers', 'md5','fun','form','table','upload','addons'],
    paths: {
        'lang'          : 'empty:',
