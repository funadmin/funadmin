    ...
    let Controller = {
        index: function () {
            ...
            Table.init = {
                ...
                tableId: 'list',
                requests:{
                    index_url: 'backend.Field/index'+$suffix,
                    add_url: 'backend.Field/add'+$suffix,
                    edit_url: 'backend.Field/edit'+$suffix,
                    delete_url: 'backend.Field/delete'+$suffix,
                    destroy_url: 'backend.Field/destroy'+$suffix,
                    modify_url: 'backend.Field/modify'+$suffix,
                }
            }
            Table.render({
