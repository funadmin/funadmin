...
$factoryFile = $root . '/app/common/plugin/sdk/PluginEntryFactory.php';
...
$functions = (string) file_get_contents($root . '/app/common/functions/plugin.php');
...
$service = (string) file_get_contents($root . '/app/common/plugin/sdk/Service.php');
...
$manifest = (string) file_get_contents($root . '/app/common/plugin/sdk/Manifest.php');
