...
use app\admin\development\exception\GenerationInterruptionException;
...
try {
    ...
    $command = (string) file_get_contents(dirname(__DIR__) . '/app/admin/command/BusinessGenerationRecover.php');
