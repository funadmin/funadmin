...
$repositorySource = (string) file_get_contents(dirname(__DIR__) . '/app/admin/form/repository/FormSchemaRepository.php');
...
$controllerSource = (string) file_get_contents(dirname(__DIR__) . '/app/admin/controller/development/Business.php');
...
$errorMapperSource = (string) file_get_contents(dirname(__DIR__) . '/app/admin/development/http/BusinessApiErrorMapper.php');
