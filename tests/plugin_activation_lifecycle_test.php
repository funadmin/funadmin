...
lifecycleActivationExpect(is_file($root . '/app/admin/command/PluginActivationCacheRebuild.php'), '必须实现 activation 手动重建命令');
...
$reflection = new ReflectionClass(\app\admin\plugin\service\PluginService::class);
...
$command = (string) file_get_contents($root . '/app/admin/command/PluginActivationCacheRebuild.php');
