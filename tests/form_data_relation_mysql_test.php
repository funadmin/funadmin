...
SQL);
    ...
    $definition = (new \app\console\development\service\FormCrudDefinitionFactory())->createFromSchema($generatedSchema, ['table_name' => 'fun_fd_string_order'], [], ['primaryKey' => ['code'], 'columns' => array_values(Db::connect('mysql')->getFields('fun_fd_string_order'))]);
