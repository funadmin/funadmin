...
$pipelineSource = (string) file_get_contents(dirname(__DIR__) . '/app/admin/plugin/service/PluginPackagePipeline.php');
...
$packageSource = (string) file_get_contents(dirname(__DIR__) . '/app/admin/plugin/service/PluginPackageService.php');
...
$historySource = (string) file_get_contents(dirname(__DIR__) . '/app/admin/plugin/service/PluginPackageService.php');
...
$controllerSource = (string) file_get_contents(dirname(__DIR__) . '/app/admin/controller/plugin/SystemPlugin.php');
