...
aiPhase2ContractExpect(!is_file($root . '/app/admin/ai/infrastructure/StubAiToolExecutor.php'), '测试 stub 不得作为生产服务保留');
$notConfigured = new app\admin\ai\infrastructure\NotConfiguredAiToolExecutor();
try {
