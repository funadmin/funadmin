...
$service = (string) file_get_contents($root . '/app/admin/plugin/service/PluginService.php');
$support = (string) file_get_contents($root . '/app/admin/plugin/service/concern/PluginServiceSupport.php');
$infrastructure = (string) file_get_contents($root . '/app/admin/plugin/service/PluginInfrastructureService.php');
$resourcePublisher = (string) file_get_contents($root . '/app/admin/plugin/service/PluginResourcePublisher.php');
$databaseRepository = (string) file_get_contents($root . '/app/admin/plugin/repository/DatabasePluginResourceRepository.php');
...
$recoveryInfrastructure = new \app\admin\plugin\service\PluginInfrastructureService();
...
$databaseAppRepository = (string) file_get_contents($root . '/app/admin/plugin/repository/DatabasePluginAppPublicationRepository.php');
