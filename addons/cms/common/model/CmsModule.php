...
EOF;
            ...
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'intro', 'SEO简介', '1',  '0', '','',  'textarea', '','','4','1', '" . time() . "',1)");
