...
CREATE TABLE `__PREFIX__addons_cms_adv` (
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_adv`
--

INSERT INTO `__PREFIX__addons_cms_adv` (`id`, `pid`, `type`, `name`, `url`, `path`, `code`, `start_time`, `end_time`, `admin_id`, `email`, `phone`, `hits`, `sort`, `status`, `target`, `bgcolor`, `create_time`, `update_time`) VALUES
...
--
-- 表的结构 `__PREFIX__addons_cms_adv_position`
--

CREATE TABLE `__PREFIX__addons_cms_adv_position` (
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_adv_position`
--

INSERT INTO `__PREFIX__addons_cms_adv_position` (`id`, `name`, `width`, `height`, `intro`, `style`, `status`, `create_time`, `update_time`, `delete_time`) VALUES
...
--
-- 表的结构 `__PREFIX__addons_cms_article`
--

CREATE TABLE `__PREFIX__addons_cms_article` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='__PREFIX__addons_cms_article模型表';

--
-- 转存表中的数据 `__PREFIX__addons_cms_article`
--

INSERT INTO `__PREFIX__addons_cms_article` (`id`, `cateid`, `uid`, `username`, `title`, `thumb`, `keywords`, `intro`, `content`, `tags`, `posid`, `status`, `recommend`, `is_read`, `readfee`, `sort`, `hits`, `create_time`, `update_time`) VALUES
...
--
-- 表的结构 `__PREFIX__addons_cms_category`
--

CREATE TABLE `__PREFIX__addons_cms_category` (
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_category`
--

INSERT INTO `__PREFIX__addons_cms_category` (`id`, `catename`, `cateflag`, `pid`, `arrpid`, `arrchildid`, `moduleid`, `module`, `type`, `title`, `keywords`, `description`, `content`, `sort`, `is_menu`, `status`, `hits`, `thumb`, `url`, `template_list`, `template_show`, `page_size`, `create_time`, `update_time`) VALUES
...
(12, '商城', 'shop', 13, '0,13', '12', 18, 'cms_product', 0, 'funadmin', 'funadmin,layui', 'funadmin,layui,插件开发', NULL, 50, 1, 1, 0, '', '', 'list_product.html', 'show_page.html', 15, 0, 1604324984),
(13, '产品服务', 'product', 0, '0', '13,2,3,4,10,11,12', 18, 'cms_product', 0, '服务产品', '服务产品', '服务产品', NULL, 50, 1, 1, 100, '', '', 'list_product.html', 'show_page.html', 15, 1582536226, 1604324984),
...
(16, '关于我们', 'about', 0, '0', '16', 19, 'cms_article', 1, '基于TP6 layui开发的cms 后台管理系统', '关于我们-funadmin', '关于我们-funadmin', '<p>深圳市<span style=\"color: rgb(102, 102, 102); font-family: &quot;Microsoft YaHei&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; text-align: justify; widows: 1;\">科技有限公司专注于互联网应用开发服务，主营业务有：网站、公众号、小程序、APP开发，企业品牌网络媒体运营推广，招商活动营销策划等服务；自成立以来，凭借良好的行业经验与技术实力，本着“高效管理”、“合作共赢”、“力创精品”的经营理念，致力于成为国内专业的产业互联网服务商；</span></p>', 50, 1, 1, 0, '', '', 'list.html', 'show_about.html', 15, 1582684581, 1604323571);

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__addons_cms_debris`
--

CREATE TABLE `__PREFIX__addons_cms_debris` (
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_debris`
--

INSERT INTO `__PREFIX__addons_cms_debris` (`id`, `pid`, `title`, `content`, `sort`, `url`, `image`, `status`, `create_time`, `update_time`) VALUES
(1, 1, '底部版权', 'Copyright © 2018-2019. funadmin | 备案：湘ICP备18009588号 | Powered by funadmin', 50, 'http://127.0.0.1:88/', '\\storage\\uploads/20201031\\e3ab4366e1c42b44892756b0a2b91444.png', 1, 1579333649, 1604317428);

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__addons_cms_debris_position`
--

CREATE TABLE `__PREFIX__addons_cms_debris_position` (
  `id` int(11) NOT NULL,
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_debris_position`
--

INSERT INTO `__PREFIX__addons_cms_debris_position` (`id`, `title`, `sort`, `status`, `create_time`, `updated_time`) VALUES
(1, '底部版权', 1, 1, 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__addons_cms_diyform`
--

CREATE TABLE `__PREFIX__addons_cms_diyform` (
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_diyform`
--

INSERT INTO `__PREFIX__addons_cms_diyform` (`id`, `name`, `title`, `seotitle`, `keywords`, `description`, `tablename`, `fields`, `needlogin`, `successtips`, `redirecturl`, `template`, `status`, `createtime`, `updatetime`) VALUES
(1, '留言', '留言', '留言', '留言', '留言', 'cms_message', 'username,mobile,wechat,', 0, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__addons_cms_field`
--

CREATE TABLE `__PREFIX__addons_cms_field` (
  `id` smallint(5) UNSIGNED NOT NULL,
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_field`
--

INSERT INTO `__PREFIX__addons_cms_field` (`id`, `diyformid`, `moduleid`, `field`, `name`, `required`, `minlength`, `maxlength`, `rule`, `msg`, `type`, `is_search`, `value`, `field_define`, `option`, `sort`, `status`, `create_time`, `update_time`) VALUES
...
--
-- 表的结构 `__PREFIX__addons_cms_link`
--

CREATE TABLE `__PREFIX__addons_cms_link` (
  `id` int(5) NOT NULL,
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_link`
--

INSERT INTO `__PREFIX__addons_cms_link` (`id`, `name`, `thumb`, `url`, `category_id`, `email`, `qq`, `sort`, `status`, `create_time`, `update_time`, `delete_time`) VALUES
(23, 'funadmin', ' ', 'https://www.funadmin.com', 0, '994927909@qq.com', '994927909', 50, 1, 1566102829, 1577524944, 0),
(25, '百度', ' ', 'https://www.baidu.com', 0, '994927909@qq.com', '994927909', 50, 1, 1566103165, 1573640285, 0),
(26, '新浪', ' ', 'https://www.sina.com', 0, '994927909@qq.com', '994927909', 50, 1, 1566103233, 1604323673, 0);

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__addons_cms_message`
--

CREATE TABLE `__PREFIX__addons_cms_message` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_message`
--

INSERT INTO `__PREFIX__addons_cms_message` (`id`, `username`, `company`, `mobile`, `wechat`, `content`, `create_time`, `update_time`) VALUES
(1, 'ce', 'ce', 'ce', 'e', 'e', NULL, NULL);

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__addons_cms_module`
--

CREATE TABLE `__PREFIX__addons_cms_module` (
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_module`
--

INSERT INTO `__PREFIX__addons_cms_module` (`id`, `modulename`, `tablename`, `intro`, `type`, `ispage`, `listfields`, `template`, `sort`, `status`, `create_time`, `update_time`, `delete_time`) VALUES
...
--
-- 表的结构 `__PREFIX__addons_cms_picture`
--

CREATE TABLE `__PREFIX__addons_cms_picture` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'ID',
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='__PREFIX__addons_cms_picture模型表';

--
-- 转存表中的数据 `__PREFIX__addons_cms_picture`
--

INSERT INTO `__PREFIX__addons_cms_picture` (`id`, `uid`, `username`, `cateid`, `title`, `title_style`, `thumb`, `keywords`, `description`, `content`, `tags`, `status`, `sort`, `hits`, `create_time`, `update_time`) VALUES
...
--
-- 表的结构 `__PREFIX__addons_cms_product`
--

CREATE TABLE `__PREFIX__addons_cms_product` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'ID',
  `uid` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '发布人id',
  `username` varchar(50) NOT NULL DEFAULT ' ' COMMENT '发布人',
  `cateid` smallint(5) UNSIGNED NOT NULL DEFAULT '0' COMMENT '栏目id',
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='__PREFIX__addons_cms_product模型表';

--
-- 转存表中的数据 `__PREFIX__addons_cms_product`
--

INSERT INTO `__PREFIX__addons_cms_product` (`id`, `uid`, `username`, `cateid`, `title`, `title_style`, `thumb`, `keywords`, `description`, `content`, `tags`, `status`, `sort`, `hits`, `create_time`, `update_time`) VALUES
...
--
-- 表的结构 `__PREFIX__addons_cms_tags`
--

CREATE TABLE `__PREFIX__addons_cms_tags` (
...
--
-- 转存表中的数据 `__PREFIX__addons_cms_tags`
--

INSERT INTO `__PREFIX__addons_cms_tags` (`id`, `name`, `hits`, `nums`, `article_ids`) VALUES
(5, 'funadmin', 8, 1, NULL),
(6, 'layui', 2, 3, ',2'),
(7, 'tp6', 0, 0, NULL),
(8, 'thinkphp', 0, 2, ',2'),
(9, 'easywechat', 0, 1, ',2'),
(10, 'requrejs', 0, 0, NULL);
...
--
-- 表的索引 `__PREFIX__addons_cms_adv`
--
ALTER TABLE `__PREFIX__addons_cms_adv`
  ADD PRIMARY KEY (`id`),
  ADD KEY `enabled` (`status`) USING BTREE,
  ADD KEY `position_id` (`pid`) USING BTREE;

--
-- 表的索引 `__PREFIX__addons_cms_adv_position`
--
ALTER TABLE `__PREFIX__addons_cms_adv_position`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `position_id` (`id`);

--
-- 表的索引 `__PREFIX__addons_cms_article`
--
ALTER TABLE `__PREFIX__addons_cms_article`
  ADD PRIMARY KEY (`id`),
...
--
-- 表的索引 `__PREFIX__addons_cms_category`
--
ALTER TABLE `__PREFIX__addons_cms_category`
  ADD PRIMARY KEY (`id`),
  ADD KEY `listorder` (`sort`),
  ADD KEY `pid` (`pid`);

--
-- 表的索引 `__PREFIX__addons_cms_debris`
--
ALTER TABLE `__PREFIX__addons_cms_debris`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `__PREFIX__addons_cms_debris_position`
--
ALTER TABLE `__PREFIX__addons_cms_debris_position`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `__PREFIX__addons_cms_diyform`
--
ALTER TABLE `__PREFIX__addons_cms_diyform`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `__PREFIX__addons_cms_field`
--
ALTER TABLE `__PREFIX__addons_cms_field`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `__PREFIX__addons_cms_link`
--
ALTER TABLE `__PREFIX__addons_cms_link`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `__PREFIX__addons_cms_message`
--
ALTER TABLE `__PREFIX__addons_cms_message`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`);

--
-- 表的索引 `__PREFIX__addons_cms_module`
--
ALTER TABLE `__PREFIX__addons_cms_module`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `__PREFIX__addons_cms_picture`
--
ALTER TABLE `__PREFIX__addons_cms_picture`
  ADD PRIMARY KEY (`id`),
  ADD KEY `status` (`id`,`status`,`sort`),
  ADD KEY `cateid` (`id`,`cateid`,`status`),
  ADD KEY `sort` (`id`,`cateid`,`status`,`sort`);
...
--
-- 表的索引 `__PREFIX__addons_cms_product`
--
ALTER TABLE `__PREFIX__addons_cms_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `status` (`id`,`status`,`sort`),
  ADD KEY `cateid` (`id`,`cateid`,`status`),
  ADD KEY `sort` (`id`,`cateid`,`status`,`sort`);
...
--
-- 表的索引 `__PREFIX__addons_cms_tags`
--
ALTER TABLE `__PREFIX__addons_cms_tags`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`);
...
--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_adv`
--
ALTER TABLE `__PREFIX__addons_cms_adv`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '广告id', AUTO_INCREMENT=9;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_adv_position`
--
ALTER TABLE `__PREFIX__addons_cms_adv_position`
  MODIFY `id` int(3) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '表id', AUTO_INCREMENT=6;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_article`
--
ALTER TABLE `__PREFIX__addons_cms_article`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=6;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_category`
--
ALTER TABLE `__PREFIX__addons_cms_category`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_debris`
--
ALTER TABLE `__PREFIX__addons_cms_debris`
  MODIFY `id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_debris_position`
--
ALTER TABLE `__PREFIX__addons_cms_debris_position`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_diyform`
--
ALTER TABLE `__PREFIX__addons_cms_diyform`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_field`
--
ALTER TABLE `__PREFIX__addons_cms_field`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_link`
--
ALTER TABLE `__PREFIX__addons_cms_link`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_message`
--
ALTER TABLE `__PREFIX__addons_cms_message`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_module`
--
ALTER TABLE `__PREFIX__addons_cms_module`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_picture`
--
ALTER TABLE `__PREFIX__addons_cms_picture`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=3;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_product`
--
ALTER TABLE `__PREFIX__addons_cms_product`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=6;

--
-- 使用表AUTO_INCREMENT `__PREFIX__addons_cms_tags`
--
ALTER TABLE `__PREFIX__addons_cms_tags`
