...
class CmsModule extends Common {
    public $title = '/**
  * lemocms
* ============================================================================
* 版权所有 2018-2027 lemocms，并保留所有权利。
...
LEMO;
            ...
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'description', 'SEO简介', '1',  '0', '', '', 'textarea','', '','5', '1', '".time()."',1 )");
...
LEMO;
            ...
            Db::execute($sql);
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'cateid', '栏目',  '1',  '6', '', '必须选择一个栏目', 'cateid', '','','1','1', '".time()."' ,0)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'title', '标题', '1',  '80', '', '标题必须为1-80个字符',  'text', '','','2', '1', '".time()."' ,1)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'keywords', '关键词','1',  '200', '','关键词必须在0-200个内',  'text','', '','3', '1', '".time()."',1)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'description', 'SEO简介', '1',  '0', '','',  'textarea', '','','4','1', '".time()."',1)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'thumb', '缩略图',  '1',  '255', '', '缩略图', 'image', '','','1','1', '".time()."' ,0)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'content', '内容', '0', '255', '', '', 'editor','0:ueditor', 'ueditor','5', '1', '".time()."' ,1)");
//            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`) VALUES ( '" . $moduleid . "', 'create_time', '创建时间',  '1',  '11', '','','datetime','', '', '6','1', '".time()."')");
//            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`) VALUES ( '" . $moduleid . "', 'update_time', '更新时间',  '1', '11','', '','datetime', '','', '6','1', '".time()."')");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'status', '状态',  '1', '1', '', '', 'radio', '0:未发布" .'\r\n'. " 1:发布','1','7','1', '".time()."' ,0)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'recommend', '允许评论',  '0', '1','', '', 'radio', '0:禁止评论" .'\r\n'. " 1:允许评论','1','8', '1', '".time()."' ,0)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'readfee', '阅读收费', '0',  '5', '','', 'number','', '0','9', '1', '".time()."' ,0)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'is_read', '是否可阅读', '0',  '1','', '', 'radio', '0:禁止 " .'\r\n'. " 1:允许','1','9', '1','".time()."' ,0)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'hits', '点击次数', '0',  '8',  '','', 'number', '','1','10','1', '".time()."' ,1)");
//            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`) VALUES ( '" . $moduleid . "', 'visite', '访问权限', '0', '1', '', '', 'radio', '0:开启 " .'\r\n'. " 1:关闭','1','11','1', '".time()."',0)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'posid', '推荐位',  '0','1', '','', 'posid','1:置顶 ".'\r\n'.'2:热门'.'\r\n'.'3:头条' . "', '','12','1', '".time()."' ,0)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'tags', '标签',  '0', '255', '', '', 'text','', '','14','1','".time()."' ,1)");
            Db::execute("INSERT INTO `" . $prefix . "cms_field` (`moduleid`,`field`,`name`,`required`,`maxlength`,`rule`,`msg`,`type`,`option`,`value`,`sort`,`status`,`create_time`,`is_search`) VALUES ( '" . $moduleid . "', 'sort', '排序',  '0', '50', '', '', 'text','', '','14','1','".time()."' ,0)");
        }
        return true;
