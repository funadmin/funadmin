...
namespace addons\wechat\api\controller;

use app\common\controller\AddonsFrontend;

use addons\wechat\common\model\WxMaterialInfo;
use addons\wechat\common\model\WxMsgHistory;
use addons\wechat\common\model\WxReply;
...
class WechatApi extends AddonsFrontend
{
    protected $where =[];
    protected $wechatApp;
    ...
    public function initialize()
    {
        ...
        $this->merchant_id =  $wechatApp->merchant_id;
        $this->wx_aid =  $wechatApp->wechat->id;
        if(!$this->wechatApp){
            $this->wechatApp = $wechatApp->wechatApp;
        }
        $this->where= ['merchant_id'=>$this->merchant_id,'wx_aid'=>$this->wx_aid];
        $this->getMessage();
    }
