...
(@form_group_id,'console','console/form.designer:version','console/form.designer','version',CONVERT(X'E69FA5E79C8BE8A1A8E58D95E78988E69CAC' USING utf8mb4),'route',1,0,75,'admin_web','form_management',NOW(),NOW(),75,NULL),
(@form_group_id,'console','console/form.designer:diff','console/form.designer','diff',CONVERT(X'E6AF94E8BE83E8A1A8E58D95E78988E69CAC' USING utf8mb4),'route',1,0,76,'admin_web','form_management',NOW(),NOW(),76,NULL),
(@form_group_id,'console','console/form.designer:rollback','console/form.designer','rollback',CONVERT(X'E59B9EE6BB9AE8A1A8E58D95E78988E69CAC' USING utf8mb4),'route',1,0,77,'admin_web','form_management',NOW(),NOW(),77,NULL),
