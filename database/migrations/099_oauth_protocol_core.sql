...
CREATE TABLE IF NOT EXISTS `fun_oauth_token` (
  ...
  CONSTRAINT `fk_oauth_token_authorization` FOREIGN KEY (`tenant_id`,`authorization_id`) REFERENCES `fun_oauth_authorization` (`tenant_id`,`id`) ON DELETE SET NULL ON UPDATE CASCADE,
