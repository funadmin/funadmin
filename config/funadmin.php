...
return [
    ...
    'auth_route_aliases'=>[
        ...
        'systemoperationlog:detail' => 'admin/systemoperationlog/index',
        'systempermission:detail' => 'admin/systempermission:tree',
        'systemmenu:permissionoptions' => 'admin/systemmenu:tree',
