...
const accounts: MockAccount[] = [
  {
    ...
    user: {
      ...
      roles: ['role:1'],
      permissions: ['*', 'system:dict:list', 'system:dict:add', 'system:dict:edit', 'system:dict:delete', 'admin/development:crud:list', 'admin/development:crud:generate', 'admin/development:crud:overwrite']
    }
  },
  {
