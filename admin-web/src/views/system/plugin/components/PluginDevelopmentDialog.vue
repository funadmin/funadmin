  ...
  <el-dialog v-model="visible" title="插件开发工具" width="760px" destroy-on-close @open="loadOptions">
    <el-tabs v-model="mode">
      <el-tab-pane label="创建插件" name="create">
        ...
        <div class="actions"><el-button v-perm="'admin/development:plugin:create-preview'" :loading="loading" @click="previewPlugin">预览</el-button><el-button v-perm="'admin/development:plugin:create'" type="primary" :loading="loading" :disabled="!preview || preview.conflicts.length > 0" @click="createPlugin">确认创建</el-button></div>
      </el-tab-pane>
      <el-tab-pane label="校验/打包" name="maintain">
        ...
        <div class="actions"><el-button v-perm="'admin/development:plugin:validate'" :loading="loading" @click="validatePlugin">校验插件</el-button><el-button v-perm="'admin/development:plugin:package'" type="primary" :loading="loading" @click="packagePlugin">打包插件</el-button><el-button v-if="result?.downloadUrl" v-perm="'admin/development:plugin:download'" tag="a" :href="result.downloadUrl">下载插件包</el-button></div>
      </el-tab-pane>
    </el-tabs>
