<template>
  ...
  <el-table :data="fields" border max-height="620" table-layout="auto">
  ...
  <FieldEditorDrawer v-model="drawerVisible" :field="activeField" />
</template>

<script setup lang="ts">
import { ref } from 'vue';
import type { CrudField } from '@/types/development/crud';
...
const activeField = ref<CrudField | null>(null);
