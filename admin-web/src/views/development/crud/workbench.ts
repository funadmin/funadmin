...
export function createCrudDefinition(connection: string, table: string, fields: CrudField[]): CrudDefinition {
  ...
  return {
    ...
    templates: { migration: 'database/migration.sql.tpl', model: 'backend/model.php.tpl', validate: 'backend/validate.php.tpl', service: 'backend/service.php.tpl', controller: 'backend/controller.php.tpl', permissionMigration: 'database/permissions.sql.tpl', api: 'frontend/api.ts.tpl', view: 'frontend/index.vue.tpl', form: 'frontend/form.vue.tpl', detail: 'frontend/detail.vue.tpl' },
