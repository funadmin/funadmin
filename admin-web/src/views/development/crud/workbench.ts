...
export function createCrudDefinition(connection: string, table: string, fields: CrudField[]): CrudDefinition {
  ...
  return {
    ...
    paths: { migration: `database/generated/${name}.sql`, model: `app/backend/model/${className}.php`, validate: `app/backend/validate/${className}Validate.php`, service: `app/backend/service/${className}Service.php`, controller: `app/backend/controller/generated/${className}Controller.php`, permissionMigration: `database/generated/${name}_permissions.sql`, phpTest: `tests/generated/${name}_api_test.php`, api: `admin-web/src/api/generated/${name}.ts`, view: `admin-web/src/views/generated/${name}/index.vue`, form: `admin-web/src/views/generated/${name}/components/${className}Form.vue`, detail: `admin-web/src/views/generated/${name}/components/${className}Detail.vue`, vueTest: `admin-web/tests/generated/${name}.spec.ts` },
    apiPrefix: `/generated/${name}`, permissionPrefix: `generated:${name}`, fields, relations: [], optionsSource: [],
    templates: { migration: 'database/migration.sql.tpl', model: 'backend/model.php.tpl', validate: 'backend/validate.php.tpl', service: 'backend/service.php.tpl', controller: 'backend/controller.php.tpl', permissionMigration: 'database/permissions.sql.tpl', phpTest: 'tests/php-test.php.tpl', api: 'frontend/api.ts.tpl', view: 'frontend/index.vue.tpl', form: 'frontend/form.vue.tpl', detail: 'frontend/detail.vue.tpl', vueTest: 'tests/vue-test.ts.tpl' },
