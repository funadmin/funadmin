...
describe('BusinessVisual', () => {
  ...
  it.each([
    ['仅检查', ['development.business:inspectdatabase'], true, false, false],
    ['仅创建', ['development.business:createvisual'], false, true, false],
    ['仅采纳', ['development.business:createfromdatabase'], false, false, true],
