...
const icons: Record<string, string> = {
  ...
  checkbox: 'i-ep-check', switch: 'i-ep-switch-button', transfer: 'i-ep-d-arrow-right', date: 'i-ep-calendar', datetime: 'i-ep-calendar',
  daterange: 'i-ep-calendar', datetimerange: 'i-ep-calendar', time: 'i-ep-timer', timeSelect: 'i-ep-watch', slider: 'i-ep-operation',
  ...
  richtext: 'i-ep-edit-pen', json: 'i-ep-document', hidden: 'i-ep-view', readonly: 'i-ep-reading', repeatable: 'i-ep-copy-document',
...
export const controlIcon = (control: Pick<ControlMeta, 'type'>): string => icons[control.type] || 'i-ep-cpu';

export const paletteContainers = (palette: HTMLElement): HTMLElement[] =>
  Array.from(palette.querySelectorAll<HTMLElement>('.palette-group-grid'));
